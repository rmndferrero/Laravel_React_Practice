...
import AvatarPreview from '../../Components/Contacts/AvatarPreview';
import { Field, Section } from '../../Components/Contacts/FormComponents';
...
export default function ContactsCreate({ contact }) {
    ...
    return (
        <>
            ...
            {/* The wrapper now fully relies on the global CSS variables */}
